...
This folder contains matlab files for K-Means-- algorithm

This folder contains files for applying PCA, K-Means-- clustering( for classification and anomaly detection) to two 3D gaussian clouds randomly generated for demonstration purpose.
